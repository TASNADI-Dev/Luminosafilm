...
export const footerUi = {
	hu: {
		...
		designBy: 'Design:',
		designName: 'Tasnadi',
		phoneLabel: '+36 20 992 0628',
		phoneAria: 'Hívás: +36 20 992 0628',
...
export const contactFormUi = {
	hu: {
		...
		submit: 'Küldés',
		submitting: 'Küldés…',
		success: 'Köszönjük! Üzeneted megkaptuk, hamarosan jelentkezünk.',
		error: 'Hiba történt az üzenet küldésekor. Helyette írj nekünk a luminosafilm@gmail.com címre.',
	...
	en: {
		...
		error: 'Something went wrong while sending your message. Instead, send an email to luminosafilm@gmail.com.',
