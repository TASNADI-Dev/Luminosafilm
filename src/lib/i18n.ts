...
export const contactFormUi = {
	hu: {
		...
		error: 'Hiba történt az üzenet küldésekor. Helyette írj nekünk a luminosafilmweb@gmail.com címre.',
	...
	en: {
		...
		error: 'Something went wrong while sending your message. Instead, send an email to luminosafilmweb@gmail.com.',
